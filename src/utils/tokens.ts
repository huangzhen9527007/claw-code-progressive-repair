...
export function doesMostRecentAssistantMessageExceed200k(
  ...
  // Use MODEL_CONTEXT_WINDOW_DEFAULT as the threshold
  // This allows the threshold to be configured via environment variable
  const THRESHOLD = MODEL_CONTEXT_WINDOW_DEFAULT
