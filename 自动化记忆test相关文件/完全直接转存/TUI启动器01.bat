...
REM Start Complete Session Saver if script exists
if exist "claude-complete-session-saver.py" (
    start /B python claude-complete-session-saver.py --max-files 10
    echo [OK] Complete Session Saver started (100% complete data mode)
    echo [INFO] Latest 10 sessions complete data will be saved to MemPalace
)
